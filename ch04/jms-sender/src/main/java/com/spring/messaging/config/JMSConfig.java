...
public class JMSConfig {
	...
	/* This is for the QueueListener, The actual QueueListener configuration works without Spring annotations
	
	@Bean
	public DefaultMessageListenerContainer customMessageListenerContainer(
			ConnectionFactory connectionFactory, MessageListener queueListener, @Value("${spring.jms.queue}") final String destinationName){
